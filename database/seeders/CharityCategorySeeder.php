...
class CharityCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $currentTimestamp = Carbon::now();
         ...
         $charityA->categories()->attach([1, 2, 3]); // St. Vincent de Paul is associated with Books, Clothing, Toys & Games
         $charityB->categories()->attach([2, 4, 5]); // Change Clothes is associated with Clothing, Furniture, Electronics
    }
}
